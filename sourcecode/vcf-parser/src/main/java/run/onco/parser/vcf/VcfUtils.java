...
import run.onco.parser.vcf.model.FormatType;
import run.onco.parser.vcf.model.InfoType;
import run.onco.parser.vcf.model.ReservedProperty;
...
public class VcfUtils {
	...
	private static final String sf_simpleAltPattern = "(?:" + // wrap the whole expression
	...
	private static final String sf_number = "(?:" + // wrap the whole expression
			"(?:\\d+|(?:<.+>))" + // numbers or symbolic IDs
			"(?::\\d+)?" + // optional insertion
			")"; // ends the nc group of the first line

	private static final Pattern sf_breakpointAltPattern = Pattern.compile("(?:" + // wrap the whole expression
	...
	public static final Pattern ALT_BASE_PATTERN = Pattern.compile("\\.|" + // means no variant
	...
	public static final Pattern FORMAT_PATTERN = Pattern.compile("[A-Z0-9_:]+");
