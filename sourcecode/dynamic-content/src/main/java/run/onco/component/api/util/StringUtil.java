...
//        System.out.println(Arrays.toString(data));
	...
	public static String capitalizeFirstLetter(String original) {
		String result = original.substring(0, 1).toUpperCase() + original.substring(1);
		return result;
	}
	
	public static String replaceLinebreaksAndSpaces(String str) {
		String stringWithoutNewlines = str.replace("\n", "").replace("\r", "");
		String stringWithoutSpaces = stringWithoutNewlines.replaceAll("\\s+", "");
