...
public class CancerGene {
  ...
  public CancerGene entrezGeneId(String entrezGeneId) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(entrezGeneId, foundation, foundationHeme, hugoSymbol, mSKHeme, mSKImpact, occurrenceCount, oncokbAnnotated, sangerCGC, vogelstein);
  }
