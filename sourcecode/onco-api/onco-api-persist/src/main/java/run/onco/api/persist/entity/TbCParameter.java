 ...
 */
@Entity
@Table(name = "TB_C_PARAM")
public class TbCParameter implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8832886850719564823L;
	...
	@Column(name = "PARAM_CODE", length = 2)
