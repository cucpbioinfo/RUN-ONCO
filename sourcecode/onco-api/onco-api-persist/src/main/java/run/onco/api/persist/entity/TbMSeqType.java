 ...
 */
@Entity
@Table(name = "TB_M_SEQ_TYPE")
public class TbMSeqType implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2477474524584423667L;
	...
	@Column(name = "SEQ_TYPE_CODE", length = 2)
	...
	@Column(name = "SEQ_TYPE_NAME", length = 20)
