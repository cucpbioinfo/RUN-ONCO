 ...
 */
@Entity
@Table(name = "TB_M_CELL_TYPE")
public class TbMCellType implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 9159528525720757236L;
	...
	@Column(name = "CELL_TYPE_CODE", length = 2)
	...
	@Column(name = "CELL_TYPE_NAME", length = 20)
