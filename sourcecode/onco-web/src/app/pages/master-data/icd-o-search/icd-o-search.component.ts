...
import { IcdOFormModalComponent } from '../../../shared/components/app-modal/master-data/icd-o-form-modal/icd-o-form-modal.component';
import { DownloadService } from '../../../shared/services/download.service';
import { UtilService } from '../../../shared/services/util.service';

@Component({
    selector: "app-icd-o-search",
    templateUrl: "./icd-o-search.component.html",
    styleUrls: ["./icd-o-search.component.scss"]
})
export class IcdOSearchComponent implements OnInit {
    ...
    public onDownload(): void {
        ...
        this.downloadService.downloadFile(ctx, serviceName, req).subscribe((res: any) => {
            ...
            console.log('O:--SUCCESS--:--Download ICD-O Template--');
        });
    }

    public import(): void {
        console.log('I:--START--:--Import Data--');
        const modalRef = this.modalService.show(IcdOFormModalComponent, 'modal-lg');
    ...
    public editItem(item: any): void {
        ...
        console.log('I:--START--:--InitEdit ICD-O--:modalConfig/', this.modalConfig);
        const modalRef = this.modalService.show(IcdOFormModalComponent, 'modal-lg', this.modalConfig);
        modalRef.subscribe((icd: any) => {
            console.log('--> icd : ', icd);
            this.search();
        });
    ...
    public viewItem(item: any): void {
        ...
        this.router.navigate(['/master-data/view-icd-o']);
    }
