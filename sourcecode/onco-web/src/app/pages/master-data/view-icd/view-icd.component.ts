...
@Component({
    selector: "app-view-icd",
    templateUrl: "./view-icd.component.html",
    styleUrls: ["./view-icd.component.scss"]
})
export class ViewIcdComponent implements OnInit {
    ...
    private doSearch(criteria: any): void {
        this.dataService
            .connect(this.constants.CTX.SECURITY, this.constants.SERVICE_NAME.SEARCH_ICD, criteria)
            .then((res: any) => {
