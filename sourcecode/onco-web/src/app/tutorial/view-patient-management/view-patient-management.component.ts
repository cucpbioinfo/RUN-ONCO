...
@Component({
    selector: 'app-view-patient-management',
    templateUrl: './view-patient-management.component.html',
    styleUrls: ['./view-patient-management.component.scss']
})
export class ViewPatientManagementComponent implements OnInit {
    ...
    public getThumbnail(fiWithoutExt: string): string {
        const featureImage = `${this.constants.IMAGE_PATH}/tutorial/patient-management/${fiWithoutExt}.png`;
        return featureImage;
    }
