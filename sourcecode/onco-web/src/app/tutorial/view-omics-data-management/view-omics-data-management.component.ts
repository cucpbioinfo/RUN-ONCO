...
@Component({
  selector: 'app-view-omics-data-management',
  templateUrl: './view-omics-data-management.component.html',
  styleUrls: ['./view-omics-data-management.component.scss']
})
export class ViewOmicsDataManagementComponent implements OnInit {
    ...
    public getThumbnail(fiWithoutExt: string): string {
        const featureImage = `${this.constants.IMAGE_PATH}/tutorial/omics-data-management/${fiWithoutExt}.png`;
        return featureImage;
    }
